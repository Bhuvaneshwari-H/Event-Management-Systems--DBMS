        ...
        <div class = "content"><!--body content holder-->
            ...
            <div class="container">
                <div class="col-md-6 contacts">
                    <h1><span class="glyphicon glyphicon-user"></span> John Smith</h1>
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email: project@gmail.com<br>
                        <span class="glyphicon glyphicon-link"></span> Facebook: www.facebook.com/project<br>
